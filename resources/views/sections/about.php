		...
		<div class="row about-padding">
			<div class="col-md-6">
	  		...
	  		<div class="col-md-6">
				...
				<p class="text-center ">Since we've opened we have striven to provide the most delicious, balanced espresso that Toronto has to offer. We stock beans from both Detour and 49th Parallel to give our customers seasonally diverse, and interesting espresso. </p>
				<p>For more information about which beans we are currently stocking please visit:</p>
				<a target="_blank" class="link-padding text-center" href="http://detourcoffee.com/">Detour Coffee</a>
				<a target="_blank" href="http://49thcoffee.com/">49th Parallel</a>
	  		</div>
		</div>
		<div class="row about-padding">
			<div class="col-md-6">
	  		...
	  		<div class="col-md-6">
	  			<img src="images/bread.jpg" class="about-box">
	  		</div>
		</div>
		<div class="row about-padding">
			<div class="col-md-6">
